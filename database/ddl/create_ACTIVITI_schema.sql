...
CREATE TABLESPACE ACTIVITI_DATA
DATAFILE 'activiti_data.dat'
SIZE 10M AUTOEXTEND ON;


CREATE TEMPORARY TABLESPACE ACTIVITI_DATA_TEMP
TEMPFILE 'activiti_data_temp.dat'
SIZE 5M AUTOEXTEND ON;

CREATE USER ACTIVITI
IDENTIFIED BY ACTIVITI
DEFAULT TABLESPACE ACTIVITI_DATA
TEMPORARY TABLESPACE ACTIVITI_DATA_TEMP;

GRANT CREATE SESSION TO ACTIVITI;
GRANT CREATE TABLE TO ACTIVITI;
GRANT CREATE VIEW TO ACTIVITI;
...
insert into ACTIVITI.ACT_GE_PROPERTY
...
create table ACTIVITI.ACT_RE_MODEL (
...
create table ACTIVITI.ACT_EVT_LOG (
    LOG_NR_ NUMBER(19),
    TYPE_ NVARCHAR2(64),
    PROC_DEF_ID_ NVARCHAR2(64),
    PROC_INST_ID_ NVARCHAR2(64),
...
create sequence ACTIVITI.ACT_evt_log_seq;

create table ACTIVITI.ACT_PROCDEF_INFO (
	ID_ NVARCHAR2(64) not null,
...
alter table ACTIVITI.ACT_GE_BYTEARRAY
    add constraint ACT_FK_BYTEARR_DEPL
    foreign key (DEPLOYMENT_ID_) 
    references ACTIVITI.ACT_RE_DEPLOYMENT (ID_);

alter table ACTIVITI.ACT_RE_PROCDEF
    add constraint ACT_UNIQ_PROCDEF
    unique (KEY_,VERSION_, TENANT_ID_);
    
create index ACTIVITI.ACT_IDX_EXE_PROCINST on ACTIVITI.ACT_RU_EXECUTION(PROC_INST_ID_);
alter table ACTIVITI.ACT_RU_EXECUTION
...
create index ACTIVITI.ACT_IDX_EXE_PROCDEF on ACTIVITI.ACT_RU_EXECUTION(PROC_DEF_ID_);
alter table ACTIVITI.ACT_RU_EXECUTION
    add constraint ACT_FK_EXE_PROCDEF 
    foreign key (PROC_DEF_ID_) 
    references ACTIVITI.ACT_RE_PROCDEF (ID_);    

create index ACTIVITI.ACT_IDX_TSKASS_TASK on ACTIVITI.ACT_RU_IDENTITYLINK(TASK_ID_);
alter table ACTIVITI.ACT_RU_IDENTITYLINK
    add constraint ACT_FK_TSKASS_TASK
    foreign key (TASK_ID_) 
    references ACTIVITI.ACT_RU_TASK (ID_);
...
create index ACTIVITI.ACT_IDX_IDL_PROCINST on ACTIVITI.ACT_RU_IDENTITYLINK(PROC_INST_ID_);
alter table ACTIVITI.ACT_RU_IDENTITYLINK
...
alter table ACTIVITI.ACT_RU_VARIABLE 
...
alter table ACTIVITI.ACT_RU_VARIABLE 
    ...
    references ACTIVITI.ACT_GE_BYTEARRAY (ID_);

create index ACTIVITI.ACT_IDX_JOB_EXCEPTION on ACTIVITI.ACT_RU_JOB(EXCEPTION_STACK_ID_);
alter table ACTIVITI.ACT_RU_JOB 
    add constraint ACT_FK_JOB_EXCEPTION
    foreign key (EXCEPTION_STACK_ID_) 
    references ACTIVITI.ACT_GE_BYTEARRAY (ID_);
    
create index ACTIVITI.ACT_IDX_EVENT_SUBSCR on ACTIVITI.ACT_RU_EVENT_SUBSCR(EXECUTION_ID_);
alter table ACTIVITI.ACT_RU_EVENT_SUBSCR
    add constraint ACT_FK_EVENT_EXEC
    foreign key (EXECUTION_ID_)
    references ACTIVITI.ACT_RU_EXECUTION(ID_);

create index ACTIVITI.ACT_IDX_MODEL_SOURCE on ACTIVITI.ACT_RE_MODEL(EDITOR_SOURCE_VALUE_ID_);
alter table ACTIVITI.ACT_RE_MODEL 
    add constraint ACT_FK_MODEL_SOURCE 
    foreign key (EDITOR_SOURCE_VALUE_ID_) 
    references ACTIVITI.ACT_GE_BYTEARRAY (ID_);

create index ACTIVITI.ACT_IDX_MODEL_SOURCE_EXTRA on ACTIVITI.ACT_RE_MODEL(EDITOR_SOURCE_EXTRA_VALUE_ID_);
alter table ACTIVITI.ACT_RE_MODEL 
    add constraint ACT_FK_MODEL_SOURCE_EXTRA 
    foreign key (EDITOR_SOURCE_EXTRA_VALUE_ID_) 
    references ACTIVITI.ACT_GE_BYTEARRAY (ID_);
    
create index ACTIVITI.ACT_IDX_MODEL_DEPLOYMENT on ACTIVITI.ACT_RE_MODEL(DEPLOYMENT_ID_);    
alter table ACTIVITI.ACT_RE_MODEL 
    add constraint ACT_FK_MODEL_DEPLOYMENT 
    foreign key (DEPLOYMENT_ID_) 
    references ACTIVITI.ACT_RE_DEPLOYMENT (ID_);        

create index ACTIVITI.ACT_IDX_PROCDEF_INFO_JSON on ACTIVITI.ACT_PROCDEF_INFO(INFO_JSON_ID_);
alter table ACTIVITI.ACT_PROCDEF_INFO 
    add constraint ACT_FK_INFO_JSON_BA 
    foreign key (INFO_JSON_ID_) 
    references ACTIVITI.ACT_GE_BYTEARRAY (ID_);

create index ACTIVITI.ACT_IDX_PROCDEF_INFO_PROC on ACTIVITI.ACT_PROCDEF_INFO(PROC_DEF_ID_);
alter table ACTIVITI.ACT_PROCDEF_INFO 
...
create table ACTIVITI.ACT_HI_VARINST (
    ID_ NVARCHAR2(64) not null,
    PROC_INST_ID_ NVARCHAR2(64),
    EXECUTION_ID_ NVARCHAR2(64),
    TASK_ID_ NVARCHAR2(64),
...
create table ACTIVITI.ACT_HI_IDENTITYLINK (
    ID_ NVARCHAR2(64),
    GROUP_ID_ NVARCHAR2(255),
    TYPE_ NVARCHAR2(255),
    USER_ID_ NVARCHAR2(255),
...
create index ACTIVITI.ACT_IDX_HI_PROCVAR_PROC_INST on ACTIVITI.ACT_HI_VARINST(PROC_INST_ID_);
create index ACTIVITI.ACT_IDX_HI_PROCVAR_NAME_TYPE on ACTIVITI.ACT_HI_VARINST(NAME_, VAR_TYPE_);
create index ACTIVITI.ACT_IDX_HI_PROCVAR_TASK_ID on ACTIVITI.ACT_HI_VARINST(TASK_ID_);
create index ACTIVITI.ACT_IDX_HI_IDENT_LNK_USER on ACTIVITI.ACT_HI_IDENTITYLINK(USER_ID_);
create index ACTIVITI.ACT_IDX_HI_IDENT_LNK_TASK on ACTIVITI.ACT_HI_IDENTITYLINK(TASK_ID_);
create index ACTIVITI.ACT_IDX_HI_IDENT_LNK_PROCINST on ACTIVITI.ACT_HI_IDENTITYLINK(PROC_INST_ID_);

create index ACTIVITI.ACT_IDX_HI_ACT_INST_PROCINST on ACTIVITI.ACT_HI_ACTINST(PROC_INST_ID_, ACT_ID_);
create index ACTIVITI.ACT_IDX_HI_ACT_INST_EXEC on ACTIVITI.ACT_HI_ACTINST(EXECUTION_ID_, ACT_ID_);
create index ACTIVITI.ACT_IDX_HI_TASK_INST_PROCINST on ACTIVITI.ACT_HI_TASKINST(PROC_INST_ID_);
...
alter table ACTIVITI.ACT_ID_MEMBERSHIP 
    add constraint ACT_FK_MEMB_GROUP 
    foreign key (GROUP_ID_) 
    references ACTIVITI.ACT_ID_GROUP (ID_);

create index ACTIVITI.ACT_IDX_MEMB_USER on ACTIVITI.ACT_ID_MEMBERSHIP(USER_ID_);
alter table ACTIVITI.ACT_ID_MEMBERSHIP 
    add constraint ACT_FK_MEMB_USER
    foreign key (USER_ID_) 
    references ACTIVITI.ACT_ID_USER (ID_);
