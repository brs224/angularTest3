...
-- used to define your custom etl extract scripts
-- works in concert with what you define in setup/database-custom-etl.xml
-- and setup/database-custom-etl-macrodef.xml