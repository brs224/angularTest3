...
/**
 * HelloWorldSmokeTest provides a simple implementation of the AppTest interface
 * as specified by the J3 Commons Web Test Framework.
 * <p>
 * This is not intended to be production code. It exists to provide an easy
 * mechanism for determining if the deployment of a new WPT-based project is
 * successful.
 * <p>
 * It is assumed that this implementation will be replaced by the developers of
 * the WPT based project with an implementation more appropriate to the specific
 * project.
 */
