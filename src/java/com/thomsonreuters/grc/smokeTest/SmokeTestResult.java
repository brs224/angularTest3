...
/**
 * <p>
 * Used by methods of <code>ComponentSmokeTest</code> and
 * <code>IntegrationSmokeTest</code> to communicate the results of a test
 * method. To create instances of this class, static factory methods are
 * provided:
 * </p>
 *
 * <p>
 * <code>SmokeTest.passed("The REST call succeeded.");</code>
 * </p>
 * <p>
 * <code>SmokeTest.failed("Unable to contact Audit Service.");</code>
 * </p>
 * <p>
 * <code>SmokeTest.fatal("Unable to establish a DB connection.");</code>
 * </p>
 */
public class SmokeTestResult {
    ...
    /**
     * Used for <code>result</code> to indicate the test failed, but not in a
     * fatal way.
     */
    ...
    /**
     * Identifies whether the test passed or failed, and if the failure is fatal
     * or not.
     */
    private int result;

    /**
     * A comment to accompany the result of the test. Can be used to explain why
     * a test failed or is marked fatal.
     */
    ...
    /**
     * Creates an instance of this class with both required fields provided. For
     * most needs, use one of the static factory methods to create instances of
     * this class instead of calling this constructor.
     *
     * @param result
     *            Use one of the TEST_XXXX values defined in this class.
     * @param comment
     *            An optional comment to describe the test outcome.
     */
    ...
    /**
     * Create an instance of this object that indicates that the test passed and
     * a helpful comment.
     * 
     * @param comment
    ...
    /**
     * Create an instance of this object that indicates that the test failed
     * with some description about the outcome.
     * 
     * @param comment
     *            Describes the outcome of the test.
    ...
    /**
     * Identifies whether the test passed or failed, and if the failure is fatal
     * or not. Compare against the TEST_XXXX values to interpret the value.
     * 
