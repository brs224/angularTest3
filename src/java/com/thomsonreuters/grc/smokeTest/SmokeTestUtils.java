...
public class SmokeTestUtils {
    ...
    private static final Logger LOGGER = 
        Logger.getLogger(SmokeTestUtils.class);
    ...
    /** Used to identify the context property that holds the HTTP response object. */
    public static final String TEST_CTX_RESPONSE = "Response";

    /** Used to identify the context property that holds the servlet context object. */
    public static final String TEST_CTX_SERVLET_CONTEXT = "ServletContext";

    
    /**
     * Static initialization of the static final variables:
     * Created only one time when the class is loaded.
     */
    static {
    ...
    /**
     * Constructor is declared private, so this class cannot be
