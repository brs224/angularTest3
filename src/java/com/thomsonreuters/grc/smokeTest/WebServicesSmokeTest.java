...
/**
 * JudicialWorkbenchSmokeTest implements the AppTest
 ...
 */
public class WebServicesSmokeTest
        implements AppTest {
    ...
    public Map<String, Object> getSmokeTests(Class<? extends Annotation> type) {
        ...
        ServletContext servletContext =
            (ServletContext) appTestContext.getObjectValue(WebServicesTestCommand.TEST_CTX_SERVLET_CONTEXT);
