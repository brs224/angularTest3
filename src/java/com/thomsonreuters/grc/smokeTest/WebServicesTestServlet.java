...
/**
 * Overrides WebTestServlet to run smoke tests that are provided with the ServletContext object. 
 */
public class WebServicesTestServlet extends WebTestServlet {
	...
	/**
     * Overrides WebTestServlet's doPost to run {@link WebServicesTestCommand} instead.
     * @param servletRequest    The request being processed.
     * @param servletResponse   The response object to write to.
     * @throws ServletException Standard exception required by API.
     * @throws IOException      Standard exception required by API.
     */
    @Override
