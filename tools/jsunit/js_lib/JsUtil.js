...
function Function_fulfills() {
	for (var i = 0; i < arguments.length; ++i) {
		...
		if (typeof I != "function" || !I.prototype)
			throw new InterfaceDefinitionError(I.toString()
					+ " is not an Interface");
		if (!this.prototype)
		...
		if (name.indexOf(className + "_") == 0) {
			...
			if (typeof (fn) == "function") {
				if (!/^[a-z_][\w]*$/.test(fnName))
					throw new FunctionGluingError("Not a valid method name: "
							+ fnName);
 ...
 * The member is true, if the script runs in the Microsoft JScript engine.
 */
JsUtil.prototype.isIIS = JsUtil.prototype.isJScript && this.Server != null;
/**
 ...
 */
JsUtil.prototype.isRhino = this.java != null && this.java.lang != null
 ...
 */
JsUtil.prototype.isShell = JsUtil.prototype.isMozillaShell
		|| JsUtil.prototype.isKJS || JsUtil.prototype.isWSH;
/**
 * Flag for Obtree C4.
 * @type Boolean
 ...
 */
JsUtil.prototype.hasCallStackSupport = JsUtil.prototype.getCaller() !== undefined;
/**
 * The global object.
 * @type Object
...
function SystemWriter__flush(str) {
	/* self-modifying code ... */
	if (JsUtil.prototype.isMozillaShell)
		this._flush = function SystemWriter__flush(str) {
